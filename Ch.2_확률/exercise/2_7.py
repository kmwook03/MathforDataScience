# --- 문제 ---
# 6번 문제에서 이 동전의 기준 확률이 0.7 ~ 0.8일 확률은?
...
less_than_80 = approximate_integral(a=0.0, b=0.8, n=1000,
                                       f=lambda x: beta_distribution(x, 15, 4)) # 기본 확률이 80% 이하일 확률

less_than_70 = approximate_integral(a=0.0, b=0.7, n=1000,
                                       f=lambda x: beta_distribution(x, 15, 4)) # 기본 확률이 70% 이하일 확률

print("70%보다 크고 80%보다 작을 확률: {0}".format(less_than_80-less_than_70)) # 0.336